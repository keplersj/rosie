...
public class PreferenceConstantsTest extends RobotTestBase {
    ...
    public void pos2RampartCommandTest() {
        ...
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos2Rampart.class);
    }
    ...
    public void pos2RoughTerrainCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos2RoughTerrain.class);
    }
    ...
    public void pos3MoteCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos3Mote.class);
    }
    ...
    public void pos3RockwallCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos3RockWall.class);
    }
    ...
    public void pos3RampartCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos3Rampart.class);
    }
    ...
    public void pos3RoughTerrainCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos3RoughTerrain.class);
    }
    ...
    public void pos4MoteCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos4Mote.class);
    }
    ...
    public void pos4RockwallCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos4RockWall.class);
    }
    ...
    public void pos4RampartCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos4Rampart.class);
    }
    ...
    public void pos4RoughTerrainCommandTest() {
        this.prefs.putString("AutonomousCommand", "Pos2RoughTerrain");
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos4RoughTerrain.class);
    }
    ...
    public void pos5MoteCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos5Mote.class);
    }
    ...
    public void pos5RockwallCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos5RockWall.class);
    }
    ...
    public void pos5RampartCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos5Rampart.class);
    }
    ...
    public void pos5RoughTerrainCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), Pos5RoughTerrain.class);
    }
    ...
    public void spyBoxCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), SpyBox.class);
    }
    ...
    public void encoderDriveStraightCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), EncoderDriveStraight.class);
    }
    ...
    public void encoderTurnDegreesCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), EncoderTurnDegrees.class);
    }
    ...
    public void gyroDriveStraightCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), GyroDriveStraight.class);
    }
    ...
    public void gyroTurnDegreesCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), GyroTurnDegrees.class);
    }
    ...
    public void ultrasonicDriveStraightCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), UltrasonicDriveStraight.class);
    }
    ...
    public void driveOverTimeCommandTest() {
        ...
        this.robot.configAutonomousCommand();
        Assertions.assertEquals(this.robot.autonomousCommand.getClass(), DriveOverTime.class);
    }
}
