...
public class RobotMap {
    ...
    public static void init() {
        ...
        ballGrabberSubsystemSpindleMotor = Registrar.victorSP(0);
        LiveWindow.addActuator("BallGrabberSubsystem", "SpindleMotor", (VictorSP) ballGrabberSubsystemSpindleMotor);
