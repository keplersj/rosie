...
public class RobotMap {
    ...
    public static CANJaguar armWindowMotor;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public static void init() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        driveTrainFrontLeftMotor = new CANTalon(10);
        ...
        driveTrainFrontRightMotor = new CANTalon(12);
        ...
        armWindowMotor = new CANJaguar(4);
        LiveWindow.addActuator("Arm", "WindowMotor", armWindowMotor);
