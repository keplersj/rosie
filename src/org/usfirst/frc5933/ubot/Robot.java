...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        SmartDashboard.putNumber("Autonomous Starting Position", 1);
        SmartDashboard.putNumber("Autonomous Barrier Number", 1);
        SmartDashboard.putNumber("Autonomous Lower Window Position", 1);
